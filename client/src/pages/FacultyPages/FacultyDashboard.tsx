...
import { getPendingEvents, getApprovedEvents, approveEvent, rejectEvent } from '../../components/TS_Exp/sharedState';
                  ...
                  <div key={event.id} className="bg-gray-800 p-4 rounded-lg">
                    <div className="flex flex-col md:flex-row justify-between">
                      ...
                      <div className="flex items-center justify-start md:justify-end space-x-2">
                        <span className={`px-2 py-1 text-xs rounded ${event.status === 'approved' ? 'bg-green-800 text-green-200' :
                        ...
                        {event.studentSubmitted ?
                          ...
                          :
                          <div className="flex items-center space-x-1 bg-purple-600 hover:bg-purple-700 px-3 py-1 rounded text-sm">
